...
class _ProfileViewState extends State<ProfileView> {
  ...
  // ─── Subscriptions (must cancel on dispose) ───────────────────────────────
      ...
      if (currentUser != null) {
        ...
        if (userDoc.exists) {
          ...
          setState(() {
            ...
            userEmail   = data['email']       ?? currentUser.email       ?? 'user@example.com';
        ...
        // No logged-in user — fall back to cache
        final prefs = await SharedPreferences.getInstance();
        if (!mounted) return;
        setState(() {
  ...
  Future<void> _logout() async {
    ...
    // Cancel any Firestore listeners FIRST
    await _userSubscription?.cancel();
    _userSubscription = null;

    try {
      // 1. Clear local cache BEFORE signOut to avoid permission errors
      //    triggering listeners on stale widgets.
      final prefs = await SharedPreferences.getInstance();
      await prefs.clear();
      ...
      // 3. Navigate — only if still mounted
      if (mounted) {
              ...
              children: [
                Row(children: [
                  const Icon(Icons.edit,
                      color: Color(0xFF00CED1), size: 28),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: isDark
                            ...
                            : Colors.grey[300],
                        border: Border.all(
                            color: const Color(0xFF00CED1), width: 3),
                      ),
                      ...
                      : SingleChildScrollView(
                          child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              // Reset data button / loading indicator
                              _isResetting
                                  ? Container(
                              ...
                              // Logout button / loading indicator
                              _isLoggingOut
                                  ? Container(
                                      padding: const EdgeInsets.all(16),
                                      decoration: BoxDecoration(
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon:
              Icon(icon, color: const Color(0xFF00CED1)),
          filled: true,
          fillColor:
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _buildNavItem(
                  Icons.person_outline_rounded, true,
