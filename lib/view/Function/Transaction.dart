// lib/view/Function/Transaction.dart
...
import './Spend_rule_view.dart'; // ✅ Import SpendingRuleView
...
class _TransactionViewState extends State<TransactionView> {
  ...
  Future<void> _deleteTransaction(
    ...
    try {
      double amount =
          ((data['amount'] ?? 0) as num).abs().toDouble();
      String type =
      ...
      await _firestore.runTransaction((transaction) async {
        ...
        double currentBalance =
            (userDoc.get('balance') ?? 0).toDouble();
        double totalIncome =
            (userDoc.get('totalIncome') ?? 0).toDouble();
        double totalExpense =
            (userDoc.get('totalExpense') ?? 0).toDouble();
        if (type == 'income') {
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
                color: isDark
                    ...
                    : Colors.grey[400]),
            prefixIcon:
                const Icon(Icons.search, color: Color(0xFF00CED1)),
            filled: true,
            fillColor:
  ...
  // ✅ Bottom sheet đã cập nhật: thêm SpendingRule, giữ nguyên các mục cũ
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Tính năng phân tích nhanh',
                style: TextStyle(
                    fontSize: 20,
            ...
            _buildAIMenuOption(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              const AIDeepAnalysisView()));
                }),
            _buildDivider(isDark),

            // ✅ Quy tắc 50/30/20 - MỚI
            _buildAIMenuOption(
                context: context,
                isDark: isDark,
                ...
                subtitle: 'Phân bổ chi tiêu theo chuẩn tài chính cá nhân',
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(
                      context,
            ...
            _buildAIMenuOption(
                ...
                title: 'Chat với BuddyAI',
                subtitle: 'Trò chuyện với trợ lý AI thông minh toàn diện',
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(
                      context,
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                  child: _buildBalanceItem('Tổng thu nhập',
                      totalIncome, Icons.arrow_downward,
                      Colors.green[300]!)),
              Container(
                  height: 40,
                  width: 1,
              ...
              Expanded(
                  child: _buildBalanceItem('Tổng chi tiêu',
                      totalExpense, Icons.arrow_upward,
                      Colors.red[300]!)),
            ],
          ),
        ],
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return TransactionWidgets.buildEmptyState(
              isDark, selectedFilter);
        }
        ...
        List<DocumentSnapshot> filteredDocs =
          ...
          if (selectedFilter == 'Income' && type != 'income')
            return false;
          if (selectedFilter == 'Expense' && type != 'expense')
            return false;
          if (searchQuery.isNotEmpty) {
            ...
            if (!title.contains(searchQuery) &&
                !category.contains(searchQuery)) return false;
          }
          return true;
        }).toList();
        ...
        for (var doc in filteredDocs) {
          ...
          if (timestamp != null) {
            String monthKey =
                TransactionWidgets.getVietnameseMonth(
                    timestamp.toDate());
  ...
  Widget _buildMonthSection(String month,
      List<DocumentSnapshot> transactions, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
              ...
              _buildNavItem(Icons.search_rounded, false,
                  ...
                  onTap: () => Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              const AnalysisView()))),
              // ✅ Voice ở giữa — bấm mở bottom sheet thay vì navigate
              _buildVoiceNavItem(isDark),
  ...
  // ✅ Voice button giờ mở bottom sheet (thay cho FAB đã xóa)
  Widget _buildVoiceNavItem(bool isDark) {
    return GestureDetector(
      onTap: () => _showAIMenuBottomSheet(isDark),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color:
                        const Color(0xFF00CED1).withOpacity(0.45),
                    blurRadius: 12,
